...
<img src="Снимок экрана 2024-09-19 135638.png" alt="image" width="400"/>
-Здесь все неплохо, но считает значительно дольше


# Выделение поверхности по центру #

<img src="Снимок экрана 2024-09-24 132153.png" alt="image" width="400"/>

- разделение на две поверхности

<img src="Снимок экрана 2024-09-24 132229.png" alt="image" width="400"/>

- поверхность между ними. Просто через минимальное расстояние до точки. Тут в соотношение 2:8 - внутренняя:внешняя поверхности