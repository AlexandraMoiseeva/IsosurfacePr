...
Все в целом расписано здесь [Статья](./smoothing.pdf), один здесь [Статья]("./Li Z., A new feature preserving mesh smoothing algorithm.pdf"), еще один с алгоритмом - [Статья](./s00158-021-03027-6.pdf). 
